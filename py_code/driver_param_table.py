...
FILE_NAME_OMEGA_0_PR= 'omega_0_pr.csv'
...
omega_0 = pd.read_csv(PATH_DATA_FOLDER+FILE_NAME_OMEGA_0_PR, header=None)
...
H = pd.read_csv(PATH_DATA_FOLDER+FILE_NAME_H, header=None)
